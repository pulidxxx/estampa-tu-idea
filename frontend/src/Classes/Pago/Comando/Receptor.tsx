...
namespace Receptor {
    ...
    export async function createInformations(
        ...
        await fetch(`${import.meta.env.VITE_API_URL}/createInformations`, {
            method: "POST",
    ...
    export async function processPayment(infoPago: {
        ...
        await fetch(`${import.meta.env.VITE_API_URL}/payment`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
    ...
    export async function createOrder(
        ...
        await fetch(`${import.meta.env.VITE_API_URL}/createOrders`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    export async function createShirts(itemData: ItemData[]): Promise<void> {
        await fetch(`${import.meta.env.VITE_API_URL}/createShirts`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
